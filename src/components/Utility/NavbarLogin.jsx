...
import NavbarSearchHook from "../../Logic/Search/NavbarSearchHook";
        ...
        >
          ...
          >
            {location.pathname.slice(1, 9) === "products" ? (
              <IconButton
                sx={{ lineHeight: 0, display: { md: "none", xs: "block" } }}
          ...
          >
            <input
              ...
              value={localStorage.getItem("searchedWord") || ""}
              onChange={onChangeSearchedWord}
            />
            <SearchOutlinedIcon
