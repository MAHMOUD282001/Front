...
import DeleteRateHook from "../../Logic/Rate/DeleteRateHook";
import { Button, Modal } from "@material-ui/core";
import EditRateHook from "../../Logic/Rate/EditRateHook";
...
function RateItem({ review }) {
  ...
  let [handleRemoveReview] = DeleteRateHook();
    ...
    <Box>
      ...
      >
        ...
        {user?._id === review?.user?._id ? (
          <Box>
            <IconButton onClick={() => handleEditReview(review?._id)}>
              <Edit
                sx={{
                  width: 20,
                  height: 20,
