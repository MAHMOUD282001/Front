...
function UserFavoriteProductsCardLogic(favProducts, product, getIsFav) {
  let theme = useTheme();
  ...
  let [loadingAdd, setLoadingAdd] = useState(true);

  let [loadingDelete, setLoadingDelete] = useState(true);
...
export default UserFavoriteProductsCardLogic;
